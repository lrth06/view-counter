...
export default function standardTemplate(props) {
    function offsetText() {
        if (props.number) {
            ...
            if (parseInt(props.number) >= 1000 &&
                parseInt(props.number) < 10000) {
                return '10';
            }
            if (parseInt(props.number) >= 10000 &&
                parseInt(props.number) < 100000) {
                return '8';
            }
            if (parseInt(props.number) >= 100000 &&
    ...
    const itsOverAMillion = props.number && parseInt(props.number) < 999999 ? props.number : '1M+';
